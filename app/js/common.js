$(function() {
    ...
    $('.hamburger').on('click',function(){
        ...
        $(".h-mnu ul").toggleClass('is-active');
    });
    $(document).on("click",function(event){
        if( $(event.target).closest(".h-mnu ul,.hamburger").length )return;
        $('.hamburger').removeClass('is-active');
        $(".h-mnu ul").removeClass('is-active');
        event.stopPropagation();
    });

    $('.ques-item').on('click',function(){
        $(this).toggleClass('is-active');
        $(this).find(".ques-hide").slideToggle();
    });
